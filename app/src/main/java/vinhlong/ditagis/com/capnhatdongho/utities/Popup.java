...
import vinhlong.ditagis.com.capnhatdongho.Editing.EditingMauKiemNghiem;
...
public class Popup extends AppCompatActivity implements View.OnClickListener {
    ...
    public Popup(MainActivity mainActivity, MapView mMapView, List<FeatureLayerDTG> layerDTGS, Callout callout) {
        ...
        this.mServiceFeatureTable = getServiceFeatureTable(layerDTGS, Constant.IDLayer.DHKHLYR);
        ...
        this.featureLayerDTG_MauDanhGia = getFeatureLayerDTG(layerDTGS, Constant.IDLayer.VATTUDONGHOTBL);
        this.editingMauKiemNghiem = new EditingMauKiemNghiem(mainActivity, featureLayerDTG_MauDanhGia, this.mServiceFeatureTable);
    ...
    private void viewMoreInfo() {
        ...
        for (Field field : this.mSelectedArcGISFeature.getFeatureTable().getFields()) {
            ...
            if (field.getName().equals(Constant.DBDONG_HO_NUOC)) {
                if (value != null)
