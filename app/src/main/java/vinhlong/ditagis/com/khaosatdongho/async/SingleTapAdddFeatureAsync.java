                ...
                listListenableEditAsync.addDoneListener(() -> {
                    try {
                        ...
                        if (featureEditResults.size() > 0) {
                            ...
                            final ListenableFuture<FeatureQueryResult> queryResultListenableFuture = this.dongHoKHSFT.queryFeaturesAsync(queryParameters, ServiceFeatureTable.QueryFeatureFields.LOAD_ALL);
