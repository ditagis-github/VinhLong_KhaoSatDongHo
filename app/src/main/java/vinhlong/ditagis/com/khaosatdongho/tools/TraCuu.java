package vinhlong.ditagis.com.khaosatdongho.tools;
...
import vinhlong.ditagis.com.khaosatdongho.async.NotifyTraCuuAdapterValueChangeAsync;
...
public class TraCuu {
    ...
    public void start() {
        ...
        dialog.show();
        Button btnTraCuu = (Button) layout_table_tracuu.findViewById(R.id.btnAccept);
    ...
    private void getQueryDiemDanhGiaAsync(String whereClause) {
        ...
        final DanhSachDongHoKHAdapter adapter = new DanhSachDongHoKHAdapter(mainActivity, items);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, final long id) {
                final DanhSachDongHoKHAdapter.Item item = adapter.getItems().get(position);
