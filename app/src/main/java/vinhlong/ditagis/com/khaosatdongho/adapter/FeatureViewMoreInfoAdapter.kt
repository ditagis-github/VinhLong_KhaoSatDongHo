...
class FeatureViewMoreInfoAdapter(private val mContext: Context,private val mRootView: ViewGroup, private val items: MutableList<Item>) : ArrayAdapter<FeatureViewMoreInfoAdapter.Item>(mContext, 0, items) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_viewmoreinfo, mRootView,false)
        }
