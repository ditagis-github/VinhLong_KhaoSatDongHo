 ...
 */
class ThongKeAdapter(private val mContext: Context,private val mRootView: ViewGroup, private val items: MutableList<Item>) : ArrayAdapter<ThongKeAdapter.Item>(mContext, 0, items) {

    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        var convertView = convertView
        if (convertView == null) {
            val inflater = mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            convertView = inflater.inflate(R.layout.item_thoigian_thongke, mRootView,false)
        }
    ...
    class Item {
        ...
        lateinit var thoigianbatdau: String
        lateinit var thoigianketthuc: String
