...
class QueryHanhChinhAsync(private val mActivity: Activity, private val mServiceFeatureTable: ServiceFeatureTable, delegate: AsyncResponse) : AsyncTask<Void, ArrayList<Feature>, Void>() {
